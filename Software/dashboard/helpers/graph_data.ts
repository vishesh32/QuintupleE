...
const AllVars = {
    ...
    real_red: new Variable("avg_red_power", "Watts", GraphType.Line, red),
    exp_red: new Variable("algo_red_power", "Watts", GraphType.Line, red),
...
const AllGraphs: GraphData[] = [
    ...
    },
    {
        title: "Red Load",
        xValue: x,
        unitData1: [AllVars.real_red, AllVars.exp_red],
        unitData2: [],
        data: [],
    },
    {
...
var LiveGraphs: GraphData[] = [
    ...
    },
    {
        title: "Demands",
        xValue: x,
        unitData1: [AllVars.real_red, AllVars.real_blue_def, AllVars.real_grey_def, AllVars.real_yellow_def],
        unitData2: [],
        data: [],
    },
    {
